...
class YiiDebugToolbar extends CWidget
{
    ...
    private function registerClientScripts()
    {
        ...
        if (false !== $this->cssFile)
        {
            ...
            // mixa
            $assets = Yii::getPathOfAlias('ygin.ext.yii-debug-toolbar.assets');
            $cs->addDependResource('yii.debugtoolbar.css', array(
              $assets.'/arrow_collapse.gif',
              $assets.'/arrow_expand.gif',
              $assets.'/bullet_toggle_minus.png',
              $assets.'/bullet_toggle_plus.png',
              $assets.'/chronometer.png',
              $assets.'/panel.png',
              $assets.'/close.png',
              $assets.'/panel-close.png',
              $assets.'/close_hover.png',
