...
class m140421_125605_ygin extends CDbMigration {
  public function safeUp() {
    ...
    if ($exists == null) {
      ...
      $this->execute("INSERT INTO `da_system_parameter` (`id_system_parameter`, `id_group_system_parameter`, `name`, `value`, `note`, `id_parameter_type`, `long_text_value`) VALUES ('project-parameter-robokassa-merchant-login', 2, 'robokassa_merchant_login', 'robokass-login', 'Логин в мерчанте робокассы', 2, '')");
      $this->execute("INSERT INTO `da_system_parameter` (`id_system_parameter`, `id_group_system_parameter`, `name`, `value`, `note`, `id_parameter_type`, `long_text_value`) VALUES ('project-parameter-robokassa-merchant-pass1', 2, 'robokassa_merchant_pass1', 'robokass-pass1', 'Пароль #1 в мерчанте робокассы', 2, '')");
      $this->execute("INSERT INTO `da_system_parameter` (`id_system_parameter`, `id_group_system_parameter`, `name`, `value`, `note`, `id_parameter_type`, `long_text_value`) VALUES ('project-parameter-robokassa-merchant-pass2', 2, 'robokassa_merchant_pass2', 'robokass-pass2', 'Пароль #2 в мерчанте робокассы', 2, '')");
