...
<h2 id="cCommentTag" class="mCommentTag"><a data-object="<?=$this->model->getIdObject();?>" data-instance="<?=$this->model->getIdInstance();?>" href="#" onclick="$('#addCommentDialog-<?=$this->id?>,.mCommentList').slideToggle(); return false"><?php echo Yii::t('CommentsModule.msg', 'Comments') . " (" .$count. ")";?></a></h2>
<?php
