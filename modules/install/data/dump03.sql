...
(116, NULL, '2Gis-карта', 1, '<script charset="utf-8" type="text/javascript" src="http://firmsonmap.api.2gis.ru/js/DGWidgetLoader.js"></script>\r\n<script charset="utf-8" type="text/javascript">new DGWidgetLoader({"borderColor":"#a3a3a3","width":"900","height":"600","wid":"85cca48bc5e612adab3258add13119c4","pos":{"lon":"37.628682025721","lat":"55.754496096475","zoom":"10"},"opt":{"ref":"hidden","card":[""],"city":"moscow"},"org":[{"id":"4504127913658730"}]});</script>\r\n<noscript style="color:#c00;font-size:16px;font-weight:bold;">Виджет карты использует JavaScript. Включите его в настройках вашего браузера.</noscript>', ''),
